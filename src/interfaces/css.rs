...
pub fn set_styles_css(interface: &RustInterface){
        ...
        //interface.check_button.style_context().add_class("boton");
        interface.commit_button.style_context().add_class("button-commit");
        //interface.branch_button.style_context().add_class("boton");
        //interface.repository_button.style_context().add_class("class_name");
