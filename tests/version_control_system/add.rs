...
mod tests {
    ...
    #[test]
    pub fn test_02_add_file_1_and_file_2_to_staging_area() {
        let (temp_dir, mut vsc) = set_up();
    ...
    #[test]
    pub fn test_04_add_file_1_the_status_is_modified() {
        let (temp_dir, mut vsc) = set_up();
        let path = create_file(&temp_dir, "file1.txt");      
    ...
    #[test]
    pub fn test_05_if_file_1_is_in_staging_area_and_add_file_1_updated_staging_area() {
        let (temp_dir, mut vsc) = set_up();
        let path = create_file(&temp_dir, "file1.txt");      
    ...
    // Falta contemplar
        // varios cambios => git add archivo1.txt archivo2.txt
