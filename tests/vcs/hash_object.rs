...
mod tests {
    ...
    pub fn test_01_calculate_hash_object_of_file_1() -> Result<(), std::io::Error> {
        ...
        assert_eq!(vcs.hash_object(&path, WriteOption::NoWrite)?, "e69de29bb2d1d6434b8b29ae775ad8c2e48c5391");
        Ok(())
    }
    ...
    pub fn test_02_calculate_hash_object_error() -> Result<(), std::io::Error> {
        ...
        let result = vcs.hash_object(&path, WriteOption::NoWrite);
    ...
    pub fn test_03_calculate_hash_object_error() -> Result<(), std::io::Error> {
        let (temp_dir, vcs) = set_up();
        let result = vcs.hash_object(&temp_dir.path(), WriteOption::NoWrite);
