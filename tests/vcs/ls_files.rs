...
mod tests {
    ...
    use rust_git::vcs::{
        commands::ls_files::LsFilesOptions, version_control_system::VersionControlSystem,
    };
    ...
    #[test]
    pub fn test_02_adding_3_files_and_commit_1_then_ls_files_returns_3(
    ) -> Result<(), std::io::Error> {
        let temp_dir = set_up();
    ...
    #[test]
    pub fn test_04_create_5_files_adding_3_then_ls_files_others_returns_2(
    ) -> Result<(), std::io::Error> {
        let temp_dir = set_up();
    ...
    #[test]
    pub fn test_05_create_5_files_adding_3_then_ls_files_cached_returns_3(
    ) -> Result<(), std::io::Error> {
        let temp_dir = set_up();
    ...
    #[test]
    pub fn test_06_create_7_files_adding_4_commit_3_delete_2_adding_1_deleted_then_ls_files_deleted_returns_1(
    ) -> Result<(), std::io::Error> {
        let temp_dir = set_up();
    ...
    #[test]
    pub fn test_07_create_7_files_adding_4_commit_3_modifie_1_delete_1_then_ls_files_modified_returns_2(
    ) -> Result<(), std::io::Error> {
        let temp_dir = set_up();
