...
mod tests {
    ...
    #[test]
    pub fn test_01_create_a_branch_then_change_to_it_and_add_a_file_in_branch_changed(
    ) -> Result<(), std::io::Error> {
        let temp_dir = set_up();
    ...
    #[test]
    pub fn test_02_add_a_file_in_master_then_create_and_change_branch_then_add_a_new_file_in_new_branch(
    ) -> Result<(), std::io::Error> {
        let temp_dir = set_up();
