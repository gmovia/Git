...
mod tests {
    ...
    use rust_git::vcs::{commands::{branch::BranchOptions, checkout::CheckoutOptions}, version_control_system::VersionControlSystem, files::current_repository::CurrentRepository};
