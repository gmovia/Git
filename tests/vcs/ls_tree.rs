...
mod tests {
    ...
    use rust_git::vcs::{version_control_system::VersionControlSystem, commands::{branch::BranchOptions, checkout::CheckoutOptions}};
    ...
    pub fn test_03_commit_2_files_in_new_branch_then_ls_tree_len_is_2() -> Result<(), std::io::Error>{
        ...
        let _ = VersionControlSystem::checkout(CheckoutOptions::CreateAndChangeBranch("new_branch"))?;
    ...
    #[test]
    pub fn test_04_commit_2_files_and_2_dirs_with_1_file_each_then_ls_tree_len_is_6() -> Result<(), std::io::Error>{
