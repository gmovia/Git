...
fn read_directory() -> Result<Vec<String>, std::io::Error>{
    ...
    for entry in entries {
        ...
        if let Some(name_str) = name.to_str() {
            ...
            return Err(std::io::Error::new(std::io::ErrorKind::Other, "Error reading directory"));
        }
    }
    Ok(pull_requests)
}
